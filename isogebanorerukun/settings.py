"""
Django settings for isogebanorerukun project.
...
SECRET_KEY = '9!de5#3p^7p=hp*9-653)$!%3-0^!7%^aqfe-ek9)%a*jw^3-1'
...
ROOT_URLCONF = 'isogebanorerukun.urls'
...
WSGI_APPLICATION = 'isogebanorerukun.wsgi.application'
